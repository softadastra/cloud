...
struct FeedbackResponse {
  ...
  vix::json::Json to_json() const { return vix::json::o("id",id,"user_id",user_id,"workspace_id",workspace_id,"category",category,"title",title,"message",message,"status",status,"created_at",created_at,"updated_at",updated_at); }
};
