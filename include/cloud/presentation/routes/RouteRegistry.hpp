 ...
 * @brief Route registry for the cloud backend.
 */

#ifndef VIX_GENERATED_BACKEND_CLOUD_ROUTE_REGISTRY_HPP
#define VIX_GENERATED_BACKEND_CLOUD_ROUTE_REGISTRY_HPP
...
#endif // VIX_GENERATED_BACKEND_CLOUD_ROUTE_REGISTRY_HPP
